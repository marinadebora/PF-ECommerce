...
const {agregarAlCarrito, borrarCarrito, asignarUsuarioAlCarrito, descargarElementoCarrito} = require("../controladores/controladorCarrito")
...
router.delete("/carrito/:id",descargarElementoCarrito)
